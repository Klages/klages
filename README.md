# ⚡ Technical QA & Systems Specialist

Hands-on QA and systems specialist experienced in end-to-end reliability, systems administration, and technical workflows. Practical background across enterprise infrastructure, mobile OS internals, telematics network pipelines, rapid CAD/3D prototyping, and modern local/agentic AI tooling.
...
* **Quality Assurance:** Designing structured test plans, regression suites, and end-to-end defect tracking using TestRail and Jira.
* **Version Control:** Repository management, branch orchestration, and release validation pipelines in GitLab.
...
* **Enterprise Infrastructure:** Windows Server configuration, Active Directory setups, and Linux host administration.
* **Virtualization & Environments:** Multi-tier VM isolation across Hyper-V and VMware alongside containerized services via Docker.
...
* **Telematics & Transport:** Edge-to-cloud telemetry pipelines, remote sensor data routing, and protocol validation.
* **Network Traffic & Auditing:** Deep packet inspection with Wireshark, active port discovery via Nmap, VLAN segmentation, and routing validation.
* **Operations & Telemetry:** Global reachability metrics via RIPE Atlas, encrypted transit tunnels, and hardened SSH access.
...
* **Edge Nodes & Embedded:** Headless Raspberry Pi testbed deployment, Toradex module validation, bare-metal flashing, and serial/UART debugging.
* **Android & Subsystem Operations:** Device provisioning, shell scripting, package lifecycle management, and log capture (`logcat`, `dmesg`) via ADB/Fastboot.

---

### 🤖 Automation, Agentic Coding & Local AI
...
* **Local AI:** Self-hosted LLMs via Ollama for offline log parsing, data sanitization, and workflow automation.
* **Agentic Workflows:** Autonomous coding agents for test scaffold generation, recursive troubleshooting, and script refactoring.
...
* **Rapid Prototyping:** Direct physical fabrication via 3D printing (FDM) for benchtop staging, wire management, and sensor brackets.
